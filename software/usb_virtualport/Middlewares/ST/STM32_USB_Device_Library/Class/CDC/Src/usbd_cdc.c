...
__ALIGN_BEGIN uint8_t USBD_CDC_CfgFSDesc[USB_CDC_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  /*---------------------------------------------------------------------------*/
  //2 IAD  Interface Association Descriptor
  0x08,	// bLength: Interface Descriptor size
  0x0B,		// bDescriptorType: IAD
  ...
  /*---------------------------------------------------------------------------*/
  //3 IAD  Interface Association Descriptor
  0x08,	// bLength: Interface Descriptor size
  0x0B,		// bDescriptorType: IAD
...
//  /*---------------------------------------------------------------------------*/
//  //4 IAD  Interface Association Descriptor
//  0x08,	// bLength: Interface Descriptor size
//  0x0B,		// bDescriptorType: IAD
                               ...
                               USBD_SetupReqTypedef *req)
{
  ...
  switch (req->bmRequest & USB_REQ_TYPE_MASK)
  {
    case USB_REQ_TYPE_CLASS :
      if (req->wLength)
      {
        if (req->bmRequest & 0x80U)
        {
          ((USBD_CDC_ItfTypeDef *)pdev->pUserData)->Control(req->bRequest,
                                                            ...
                                                            req->wLength, pdev->request.wIndex);
      ...
      {
        ((USBD_CDC_ItfTypeDef *)pdev->pUserData)->Control(req->bRequest,
                                                          (uint8_t *)(void *)req, 0U, pdev->request.wIndex);
      }
      break;
...
static uint8_t  USBD_CDC_EP0_RxReady(USBD_HandleTypeDef *pdev)
{
  ...
  if ((pdev->pUserData != NULL) && (hcdc->CmdOpCode != 0xFFU))
  {
    ((USBD_CDC_ItfTypeDef *)pdev->pUserData)->Control(hcdc->CmdOpCode,
                                                      (uint8_t *)(void *)hcdc->data,
                                                      (uint16_t)hcdc->CmdLength, pdev->request.wIndex);
